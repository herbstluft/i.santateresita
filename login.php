      ...
      <div id="formContent">
        ...
        <input type="text" class="form-control" placeholder="Correo Electronico" aria-label="Correo Electronico" name="correo">
          ...
          <select class="sombras" aria-label="Default select example" name="select" method="post">
            <option class="sombras" value="1" method="post">Cliente</option>
            <option class="sombras" value="2" method="post">Administrador</option>
            <option class="sombras" value="3" method="post">Doctor</option>
          </select>
