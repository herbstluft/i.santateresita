...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-08-2022 a las 13:01:55
...
INSERT INTO `detalle_orden` (`id_do`, `id_producto`, `cantidad`, `cliente`, `estatus`) VALUES
(38, 1, 1, 'juanii', 0),
(39, 3, 1, 'juanii', 1),
(55, 1, 5, 'gemaaa', 1);
...
INSERT INTO `orden` (`id_orden`, `detalle`, `fecha`) VALUES
(2, 38, '2022-08-09');
...
--
ALTER TABLE `detalle_orden`
  MODIFY `id_do` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
