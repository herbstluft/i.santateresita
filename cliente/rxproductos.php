...
$reporte="SELECT TYR.nom_producto, TYR.precio, TYR.cantidad, TYR.SUBTOTAL, TYR.IVA ,(TYR.SUBTOTAL + TYR.IVA)as TOTAL 
  ...
  <nav class="navbar navbar-expand-lg barra sticky-top" >
    <div class="container-fluid">
      ...
      <button class="btn sombras iniciar" type="submit" style="height: 50px; width:10%; position: relative;" >
              <a  href="mis_compras.php" style="text-decoration:none"> < Atras </a></button>
</div>
