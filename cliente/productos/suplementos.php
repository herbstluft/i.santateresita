...
session_start();
$obj= new conexion();
$productos=$obj->consultar("select * from  productos inner JOIN categoria on productos.id_cat=categoria.id_cat WHERE categoria.categoria='Suplementos alimenticios';");
?>
